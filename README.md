...
```
cmake .. -G "Ninja" -DCMAKE_C_COMPILER=/opt/rocm-6.2.1/lib/llvm/bin/clang -DCMAKE_CXX_COMPILER=/opt/rocm-6.2.1/lib/llvm/bin/clang++ -DSD_HIPBLAS=ON -DCMAKE_BUILD_TYPE=Release -DAMDGPU_TARGETS=gfx1100
cmake --build . --config Release
```
